...
def build_char_id(input_doc, tokenizer):
    """
    ...
    words = []
    for line in lines:
        sentence = line["sentText"]
        token_sent = [tokenizer.cls_token] + tokenizer.tokenize(sentence) + [tokenizer.sep_token]
